  ...
  <div>
    <el-card class="box-card">
      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-position="left" label-width="80px"
        ...
        <!-- 判断是用户还是管理员 -->
        <!-- <el-radio v-model="ruleForm.admin" label="1" style="margin-left: 30px;">管理员</el-radio>
                <el-radio v-model="ruleForm.admin" label="2" style="margin-left: 40px;">普通用户</el-radio>
                <br><br> -->
